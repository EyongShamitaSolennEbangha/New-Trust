...
// // src/services/faceMatch.service.js
// const logger = require('../config/logger');

// exports.compareFaces = async (idPhotoPath, selfiePath) => {
//   logger.warn('⚠️ Using mock face match – always returning true');
//   return { matched: true, confidence: 100, score: 1.0 };
// };

// exports.detectFace = async (imagePath) => {
//   logger.warn('⚠️ Using mock face detection – returning one face');
//   return { facesDetected: 1, hasExactlyOneFace: true };
// };